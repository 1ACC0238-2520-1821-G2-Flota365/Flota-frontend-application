  ...
  <div>
      ...
      <div class="card" style="flex: 1; padding: 0; display: flex; flex-direction: column;">
        ...
        <div style="padding: 1rem; border-top: 1px solid var(--color-gray-medium); background-color: var(--color-gray-light);">
          <div style="display: flex; justify-content: space-between;">
            ...
            <strong>{{ mockVehicles.length }}</strong>
          </div>
    ...
    <div class="card" style="margin-top: 1.25rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 0.75rem;">
        <div 
          v-for="(alert, index) in mockAlerts" 
          :key="index"
...
export default {
  ...
  data() {
    return {
      ...
      // Datos mock mínimos para el monitoreo
      mockVehicles: [
        { id: 1, model: 'Toyota Hilux', plate: 'ABC-123', driver: 'Juan Pérez', speed: 45, status: 'active', location: { lat: -12.0464, lng: -77.0428 } },
        { id: 2, model: 'Ford Ranger', plate: 'XYZ-789', driver: 'María García', speed: 0, status: 'inactive', location: { lat: -12.0564, lng: -77.0528 } },
        { id: 3, model: 'Nissan Frontier', plate: 'GHI-456', driver: 'Carlos López', speed: 60, status: 'warning', location: { lat: -12.0364, lng: -77.0328 } }
      ],
      mockAlerts: [
        { type: 'error', title: 'Vehículo detenido', description: 'El vehículo XYZ-789 lleva más de 30 minutos sin movimiento', time: '15 min' },
        { type: 'warning', title: 'Exceso de velocidad', description: 'El vehículo GHI-456 excede el límite de velocidad permitido', time: '25 min' },
        { type: 'info', title: 'Ruta completada', description: 'El vehículo ABC-123 completó exitosamente su ruta asignada', time: '1 hora' }
      ]
    }
  },
  computed: {
    filteredVehicles() {
      ...
      return this.mockVehicles.filter(v => v.status === this.filterStatus)
    }
  },
  methods: {
